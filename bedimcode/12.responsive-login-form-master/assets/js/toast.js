...
function toast({
   ...
   if (!main){
       ...
       (positionBottom !== null) ?  main.style.bottom = positionBottom :  main.style.top = positionTop ;
       (positionLeft !== null) ? main.style.left = positionLeft : main.style.right = positionRight ;
